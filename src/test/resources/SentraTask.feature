...
## Login with credentials of the new user with Asserts ##
 @ScenarioUserLogin  
    Scenario: User navigates and logs in to the Sentra Login with incorrect credentials, the user can't access to Sentra Task
        Given As a user I navigate to the Sentra application
        When I fill in the fields with user "elolabastiantest@gmail.com", password "Sentra2025"
